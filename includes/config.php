...
defined('APP_ENV')        || define('APP_ENV', 'development');        // development | production
defined('APP_DEBUG')      || define('APP_DEBUG', APP_ENV === 'development');
defined('DB_PATH')        || define('DB_PATH', dirname(__DIR__) . '/data/cgs.sqlite');
defined('UPLOAD_DIR')     || define('UPLOAD_DIR', dirname(__DIR__) . '/uploads');
defined('SESSION_NAME')   || define('SESSION_NAME', 'cgs_session');
defined('ADMIN_DEFAULT_USER')     || define('ADMIN_DEFAULT_USER', 'admin');
defined('ADMIN_DEFAULT_PASSWORD') || define('ADMIN_DEFAULT_PASSWORD', 'stewardship'); // seeded once, change it in Admin > Settings > Account
